...
function SiriOrb({
  ...
  const sizeValue = parseInt(size.replace("px", "").replace("vmin", ""), 10)
  const blurAmount = Math.max((sizeValue || 200) * 0.08, 8)
  const contrastAmount = Math.max((sizeValue || 200) * 0.003, 1.8)
