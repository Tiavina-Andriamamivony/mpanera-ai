...
function RefusedScreen() {
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center gap-5 text-center">
      ...
      <p className="text-muted-foreground max-w-md font-serif text-lg italic">
        Nous transmettons au client. À très vite pour une autre mission.
      </p>
      <Link
        href="/"
        className="border-border hover:bg-card mt-4 inline-flex items-center rounded-full border px-7 py-3 text-base font-medium transition"
      >
        Retour à l&apos;accueil
      </Link>
    </div>
